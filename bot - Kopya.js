...
client.on('ready', () => {
  console.log(`[BOT] ${client.user.tag} İsmiyle giriş yaptı!`);
});
...
client.on('message', message => {
  if (message.content === 'ping') {
    ...
    message.reply('AleykümSelam , Hoşgeldin reiz.');
  }
 ...
 if (message.content === prefix + 'reboot') {
	  ...
	  if (message.author.id === "217696729129156608") {
...
client.login('NDE2MjA5ODk2NTY5MzA3MTM2.DlHIfQ.SQEwFIxZMOgukrTsyyEFA98uUFs');